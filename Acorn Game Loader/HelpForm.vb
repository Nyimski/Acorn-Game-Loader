...
Public Class HelpForm
    ...
    Public Sub New()
        ' Form setup
        Me.Text = "Acorn Game Loader Help"
        Me.Icon = Form1.Icon
    ...
    Private Sub FormatHelpText(rtb As RichTextBox)
        ...
        ' Format main title
        Dim titleIndex = rtb.Text.IndexOf("Acorn Game Loader - Complete User Guide")
        If titleIndex >= 0 Then
            rtb.Select(titleIndex, "Acorn Game Loader - Complete User Guide".Length)
